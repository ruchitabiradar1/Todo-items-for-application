...
module.exports = "<div [ngClass]=\"setClasses()\"> \n  <p>\n   <input (change)=\"onToggle(atodo)\"type=\"checkbox\" />\n    {{atodo.title}}\n    <button (click)=\"onDelete(atodo)\" class=\"del\">x</button>\n  </p>\n</div>"
...
module.exports = "<app-todo-item *ngFor=\"let v of todos\" [atodo]=\"v\"\n(deleteTodo)=\"deleteatodo($event)\">\n</app-todo-item>"
...
module.exports = ".del{\n    background : #ff0000;\n    color: #fff;\n    border: none;\n    padding: 5px 9px;\n    border-radius:50%;\n    cursor: pointer;\n    float:right;\n}\n\n.todo{\n    background: #f4f4f4;\n    padding: 10px;\n    border-bottom: 1px #ccc dotted;\n}\n\n.is-complete{\n    text-decoration: line-through;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_servetodo_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/servetodo.service */ "./src/app/services/servetodo.service.ts");
...
let TodoItemComponent = class TodoItemComponent {
    ...
    onToggle() {
        ...
        //toggle server
        this.todoService.ToggleCompleted(this.atodo).subscribe(atodo => console.log(atodo));
    }
    onDelete() {
...
], TodoItemComponent.prototype, "atodo", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
TodoItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_servetodo_service__WEBPACK_IMPORTED_MODULE_3__["ServetodoService"]])
], TodoItemComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_servetodo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/servetodo.service */ "./src/app/services/servetodo.service.ts");
...
TodosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_servetodo_service__WEBPACK_IMPORTED_MODULE_2__["ServetodoService"]])
], TodosComponent);
...
/***/ "./src/app/services/servetodo.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/servetodo.service.ts ***!
  \***********************************************/
/*! exports provided: ServetodoService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServetodoService", function() { return ServetodoService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ServetodoService = class ServetodoService {
    constructor(http) {
        this.http = http;
...
ServetodoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! /Users/ruchitabiradar/angular-crash-todolist/src/main.ts */"./src/main.ts");
