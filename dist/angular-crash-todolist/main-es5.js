...
var TodoItemComponent = /** @class */ (function () {
    ...
    TodoItemComponent.prototype.onToggle = function () {
        ...
        //toggle server
        this.todoService.ToggleCompleted(this.atodo).subscribe(function (atodo) {
            return console.log(atodo);
        });
    };
...
var TodosComponent = /** @class */ (function () {
    ...
    TodosComponent.prototype.deleteatodo = function (atodo) {
        this.todos = this.todos.filter(function (t) { return t.id != atodo.id; });
...
var ServetodoService = /** @class */ (function () {
    function ServetodoService(http) {
        this.http = http;
        this.todosUrl = 'https://jsonplaceholder.typicode.com/todos';
        this.todoslimit = '?_limit=20';
    }
    ServetodoService.prototype.getTodos = function () {
        return this.http.get("" + this.todosUrl + this.todoslimit);
    };
    ServetodoService.prototype.ToggleCompleted = function (atodo) {
        var url = this.todosUrl + "/" + atodo.id;
        return this.http.put(url, atodo, httpOptions);
    };
    ServetodoService.prototype.deleteoneTodo = function (atodo) {
        var url = this.todosUrl + "/" + atodo.id;
